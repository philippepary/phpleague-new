...
/*
Plugin Name: Championnats FST22
Plugin URI: https://github.com/thewheat/PHPLeague-for-WP
Description: Gestion des championnats et matches
Version: 1.4.7
...
if ( ! class_exists('PHPLeague')) {
    ...
    class PHPLeague {
        ...
        public function __construct()
        {
            ...
            require_once WP_PHPLEAGUE_PATH.'inc/sports/volley.php';
        ...
        public function plugin_admin_init()
        {
            ...
            {
                if ( ! current_user_can('manage_phpleague') && $_GET['page'] != "phpleague_my_results")
        ...
        public function plugin_check_upgrade()
        {
            ...
            // TODO: upgrade script for sport in league
            // TODO: upgrade script for non playing team in fixtures
            // TODO: upgrade script for team WordPress user
            // TODO: upgrade script for club contact info
        ...
        public static function activate()
        {
            ...
            $sql = "number tinyint(3) unsigned NOT NULL DEFAULT '0',
                ...
                non_playing_team_id smallint(5) unsigned DEFAULT NULL,
                PRIMARY KEY (id),
        ...
        public function shortcodes_controller($attributes)
        {
            ...
            elseif ($type == 'clubs') // Display all clubs
            {
